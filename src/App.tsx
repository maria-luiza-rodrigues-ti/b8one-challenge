...
function App() {
  ...
  return (
    <main>
      <div className="App flex gap-32 items-center justify-center mx-40 mt-40 w-4/5">
        {productsList &&
          productsList.map((product) => (
            ...
            >
              <div className="relative">
                ...
                <img src={product.image} className="max-w-60" />
              </div>
              <h1 className="font-medium text-sm text-grayscale-900 line-clamp-3">
                {product.title}
              </h1>
              <div>
